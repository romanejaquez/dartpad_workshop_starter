  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: Container(
        ...
        // TODO: add Step #1 - replace Builder by LayoutBuilder
        child: Builder(
          
          // TODO: add Step #2 - add the constraints parameter
          builder: (context) {
          
            // TODO: add Step #3 - extract the constraints'
            // maxWidth and maxHeight
            var childMaxWidth = 0.0;
            var childMaxHeight = 0.0;
